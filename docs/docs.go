...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.ExConsumeReq"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Bad request",
                        "schema": {
                            "$ref": "#/definitions/api.ExTransferApiError"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/api/extransfer/download": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Signature of 'DOWNLOAD:' + session_id",
                        "name": "signature",
                        "in": "query",
                        "required": true
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.ExValidateReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/servers/{serverId}/extransfer/create": {
            "post": {
                "security": [
                    {
                        "OAuth2Application": [
