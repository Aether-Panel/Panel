...
var (
	...
	// Admin view sub-permissions (granular admin section gating)
	ScopeAdminView           = registerServerScope("server.admin.view")
	ScopeAdminInstallView    = registerServerScope("server.admin.install.view")
	ScopeAdminInstallManage  = registerServerScope("server.admin.install.manage")
	ScopeAdminTransferView   = registerServerScope("server.admin.transfer.view")
	ScopeAdminTransferManage = registerServerScope("server.admin.transfer.manage")
	ScopeAdminConfigView     = registerServerScope("server.admin.config.view")
	ScopeAdminConfigManage   = registerServerScope("server.admin.config.manage")
	ScopeAdminAssignmentsView   = registerServerScope("server.admin.assignments.view")
	ScopeAdminAssignmentsManage = registerServerScope("server.admin.assignments.manage")
