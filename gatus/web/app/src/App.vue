        ...
        <div class="container mx-auto px-4 py-6 max-w-7xl">
          <div class="flex flex-col items-center gap-4">
            <div class="text-sm text-muted-foreground text-center">
              Powered by <a href="https://skypanel.io" target="_blank" class="font-medium text-emerald-800 hover:text-emerald-600">skypanel</a>
            </div>
            <Social />
          </div>
        </div>
    ...
    <div v-else id="login-container" class="flex items-center justify-center min-h-screen p-4">
      <Card class="w-full max-w-md">
        <CardHeader class="text-center">
          ...
          />
          <CardTitle class="text-3xl">skypanel</CardTitle>
