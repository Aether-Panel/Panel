...
func (s *APIKeyService) GenerateKey(name string, permissions []string) (string, *domain.APIKey, error) {
...
func (s *APIKeyService) ValidateKey(token string) (*domain.APIKey, error) {
...
func (s *APIKeyService) GetAll() ([]*domain.APIKey, error) {
...
func (s *APIKeyService) Delete(id uint) error {
	return s.DB.Delete(&domain.APIKey{}, id).Error
}
